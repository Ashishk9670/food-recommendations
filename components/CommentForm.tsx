...
export default function CommentForm({ recommendationId }: { recommendationId: number }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      <div>
        <label htmlFor="comment-author" className="mb-1 block text-sm font-medium text-stone-700">
      ...
      <div>
        <label htmlFor="comment-body" className="mb-1 block text-sm font-medium text-stone-700">
          Comment
        </label>
        <textarea
          id="comment-body"
